    ...
    <div className="home-container">
        ...
        <header data-thq="thq-navbar" className="home-navbar-interactive">
          ...
          <div className="home-items">
            <div className="home-links">
              ...
              <svg viewBox="0 0 760.0274285714286 1024" className="home-icon04">
            ...
            >
              ...
              <div className="home-items1">
                <div className="home-links1">
                  ...
                  <span className="nav-link">WHALECARDS</span>
                ...
                <button className="start-button button home-button2">
                  <span className="home-text10">Connect</span>
                </button>
              </div>
            </div>
          </div>
      ...
      <div className="home-video">
        <div className="home-container05">
          <button className="home-button3 start-button button">
            <span className="home-text11">ENTER WHALEVERSE</span>
          </button>
        </div>
      </div>
            ...
            <div className="home-details">
              <div className="home-header2">
                <div className="home-heading">
                  <span className="home-text12">STAKE BWYC</span>
            ...
            <div className="home-details01">
              <div className="home-header3">
                <div className="home-heading1">
                  <span className="home-text18">Whalecard pass</span>
                  <div className="link">
            ...
            <div className="home-details02">
              <div className="home-header4">
                <div className="home-heading2">
                  <span className="home-text20">Whale mutants</span>
      ...
      <div className="home-about">
        ...
        <div className="home-statistics">
          <span className="home-text22">stats</span>
        ...
        <div className="home-client-list">
            ...
            <div className="home-list1">
              ...
              <div className="home-item1 service">
                <div className="home-details04">
                  <span className="home-text26">Chatroom</span>
                  <span className="home-text27">Decentralized chatroom</span>
                </div>
              ...
              <div className="home-item2 service">
                <div className="home-details05">
                  <span className="home-text28">Discord Gate</span>
              ...
              <div className="home-item3 service">
                <div className="home-details06">
                  <span className="home-text30">Staking Pool</span>
          ...
          <div className="home-row1">
            <span className="home-text32">2023 SEPTEMBER</span>
            <div className="home-list2">
              <div className="home-item4 service">
                <div className="home-details07">
                  <span className="home-text33">CARD MARKETPLACE</span>
              ...
              <div className="home-item5 service">
                <div className="home-details08">
                  <span className="home-text35">CROSS-CHAINS</span>
              ...
              <div className="home-item6 service">
                <div className="home-details09">
                  <span className="home-text37">Ordinals</span>
          ...
          <div className="home-row2">
            <span className="home-text39">2023 OCTOBER</span>
            <div className="home-list3">
              <div className="home-item7 service">
                <div className="home-details10">
                  <span className="home-text40">DAO GOVERNANCE</span>
        ...
        <div className="home-information">
          <div className="home-details12">
            ...
            <button className="home-button4 start-button button">
              <span className="home-text52">ENTER WHALESVERSE</span>
            </button>
          </div>
